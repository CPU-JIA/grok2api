(() => {
  ...
  const TAB_COVERED_SECTIONS = new Set(
    CONFIG_TABS.flatMap((tab) => tab.sections),
  );
  ...
  const LOCALE_MAP = {
    app: {
      ...
      api_key: {
        title: "API 密钥",
        desc: "调用 Grok2API 服务的 Token（可选）。",
      },
      app_key: {
        title: "后台密码",
        desc: "登录 Grok2API 管理后台的密码（必填）。",
      },
      public_enabled: {
        title: "启用功能玩法",
        desc: "是否启用功能玩法入口（关闭则功能玩法页面不可访问）。",
      },
      public_key: {
        title: "Public 密码",
        desc: "功能玩法页面的访问密码（可选）。",
      ...
      session_secret: {
        title: "会话密钥",
        desc: "用于签名后台/Public 会话 Cookie，建议设置强随机值。",
      },
      admin_session_ttl_hours: {
        title: "后台会话时长",
        desc: "后台会话 Cookie 有效期（小时）。",
      },
      public_session_ttl_hours: {
        title: "Public 会话时长",
        desc: "Public 会话 Cookie 有效期（小时）。",
      },
      app_url: {
        title: "应用地址",
        desc: "当前 Grok2API 服务的外部访问 URL，用于文件链接访问。",
      },
      image_format: {
        title: "图片格式",
        desc: "默认生成的图片格式（url 或 base64）。",
      },
      video_format: {
        title: "视频格式",
        desc: "默认生成的视频格式（html 或 url，url 为处理后的链接）。",
      },
      temporary: { title: "临时对话", desc: "是否默认启用临时对话模式。" },
      disable_memory: {
        title: "禁用记忆",
        desc: "是否默认禁用 Grok 记忆功能。",
      },
      stream: { title: "流式响应", desc: "是否默认启用流式输出。" },
      thinking: { title: "思维链", desc: "是否默认启用思维链输出。" },
      dynamic_statsig: {
        title: "动态指纹",
        desc: "是否默认启用动态生成 Statsig 指纹。",
      },
      filter_tags: {
        title: "过滤标签",
        desc: "设置自动过滤 Grok 响应中的特殊标签。",
      },
    },
    ...
    proxy: {
      ...
      base_proxy_url: {
        title: "基础代理 URL",
        desc: "代理请求到 Grok 官网的基础服务地址。",
      },
      asset_proxy_url: {
        title: "资源代理 URL",
        desc: "代理请求到 Grok 官网的静态资源（图片/视频）地址。",
      },
      pool_url: {
        title: "代理池 URL",
        desc: "动态代理池地址，返回可用代理 URL。",
      },
      pool_refresh_sec: {
        title: "代理池刷新间隔",
        desc: "动态代理池刷新周期（秒）。",
      ...
      pool_403_max: {
        title: "403 换 IP 重试",
        desc: "遇到 403 时最多换代理重试次数。",
      },
      cf_clearance: {
        title: "CF Clearance",
        desc: "Cloudflare Clearance Cookie，用于绕过反爬虫验证。",
      },
      browser: {
        title: "浏览器指纹",
        desc: "curl_cffi 浏览器指纹标识（如 chrome136）。",
      },
      user_agent: {
        title: "User-Agent",
        desc: "HTTP 请求的 User-Agent 字符串，需与浏览器指纹匹配。",
      },
    },
    ...
    retry: {
      ...
      max_retry: {
        title: "最大重试次数",
        desc: "请求 Grok 服务失败时的最大重试次数。",
      },
      retry_status_codes: {
        title: "重试状态码",
        desc: "触发重试的 HTTP 状态码列表。",
      },
      retry_backoff_base: {
        title: "退避基数",
        desc: "重试退避的基础延迟（秒）。",
    ...
    chat: {
      ...
      stream_first_timeout: {
        title: "首次响应超时",
        desc: "首个流式 chunk 的最大等待时间（秒）。",
      },
      stream_timeout: {
        title: "块间空闲超时",
        desc: "流式 chunk 间最大空闲时间（秒）。",
      },
      stream_total_timeout: {
        title: "总流式超时",
        desc: "单次流式请求总超时（秒）。",
    ...
    image: {
      ...
      stream_timeout: {
        title: "块间空闲超时",
        desc: "WebSocket 流式 chunk 间最大空闲时间（秒）。",
      },
      stream_total_timeout: {
        title: "总流式超时",
        desc: "单次流式请求总超时（秒）。",
    ...
    asset: {
      ...
      upload_concurrent: {
        title: "上传并发",
        desc: "上传接口的最大并发数。推荐 30。",
      },
      upload_timeout: {
        title: "上传超时",
        desc: "上传接口超时时间（秒）。推荐 60。",
      },
      download_concurrent: {
        title: "下载并发",
        desc: "下载接口的最大并发数。推荐 30。",
      },
      download_timeout: {
        title: "下载超时",
        desc: "下载接口超时时间（秒）。推荐 60。",
      },
      list_concurrent: {
        title: "查询并发",
        desc: "资产查询接口的最大并发数。推荐 10。",
      },
      list_timeout: {
        title: "查询超时",
        desc: "资产查询接口超时时间（秒）。推荐 60。",
      },
      list_batch_size: {
        title: "查询批次大小",
        desc: "单次查询可处理的 Token 数量。推荐 10。",
      },
      delete_concurrent: {
        title: "删除并发",
        desc: "资产删除接口的最大并发数。推荐 10。",
      },
      delete_timeout: {
        title: "删除超时",
        desc: "资产删除接口超时时间（秒）。推荐 60。",
      },
      delete_batch_size: {
        title: "删除批次大小",
        desc: "单次删除可处理的 Token 数量。推荐 10。",
      },
    },
    ...
    token: {
      ...
      auto_refresh: {
        title: "自动刷新",
        desc: "是否开启 Token 自动刷新机制。",
      },
      refresh_interval_hours: {
        title: "刷新间隔",
        desc: "普通 Token 刷新的时间间隔（小时）。",
      },
      super_refresh_interval_hours: {
        title: "Super 刷新间隔",
        desc: "Super Token 刷新的时间间隔（小时）。",
      },
      fail_threshold: {
        title: "失败阈值",
        desc: "单个 Token 连续失败多少次后被标记为不可用。",
      },
      cooldown_error_requests: {
        title: "错误次数冷却",
        desc: "普通错误后，Token 需要跳过的请求次数。",
      },
      cooldown_429_quota_sec: {
        title: "429 有额度冷却",
        desc: "429 且仍有额度时冷却秒数。",
      ...
      save_delay_ms: {
        title: "保存延迟",
        desc: "Token 变更合并写入的延迟（毫秒）。",
      },
      usage_flush_interval_sec: {
        title: "用量落库间隔",
        desc: "用量类字段写入数据库的最小间隔（秒）。",
      },
      reload_interval_sec: {
        title: "同步间隔",
        desc: "多 worker 场景下 Token 状态刷新间隔（秒）。",
      },
    },
    ...
    cache: {
      ...
      enable_auto_clean: {
        title: "自动清理",
        desc: "是否启用缓存自动清理，开启后按上限自动回收。",
      },
      limit_mb: {
        title: "清理阈值",
        desc: "缓存大小阈值（MB），超过阈值会触发清理。",
      },
    },
    ...
    nsfw: {
      ...
      concurrent: {
        title: "并发上限",
        desc: "批量开启 NSFW 模式时的并发请求上限。推荐 10。",
      },
      batch_size: {
        title: "批次大小",
        desc: "批量开启 NSFW 模式的单批处理数量。推荐 50。",
      },
      timeout: {
        title: "请求超时",
        desc: "NSFW 开启相关请求的超时时间（秒）。推荐 60。",
      },
    },
    ...
    usage: {
      ...
      concurrent: {
        title: "并发上限",
        desc: "批量刷新用量时的并发请求上限。推荐 10。",
      },
      batch_size: {
        title: "批次大小",
        desc: "批量刷新用量的单批处理数量。推荐 50。",
      },
      timeout: {
        title: "请求超时",
        desc: "用量查询接口的超时时间（秒）。推荐 60。",
      },
    },
    ...
    conversation: {
      ...
      ttl_seconds: {
        title: "会话 TTL",
        desc: "会话过期时间（秒），过期自动清理。",
      },
      max_per_token: {
        title: "单 Token 上限",
        desc: "每个 Token 最多保留会话数量。",
      },
      cleanup_interval_sec: {
        title: "清理间隔",
        desc: "会话自动清理的轮询间隔（秒）。",
    ...
    mcp: {
      ...
      enabled: {
        title: "启用 MCP",
        desc: "是否启用 MCP streamable-http 服务。",
      },
      mount_path: { title: "挂载路径", desc: "MCP HTTP 子应用挂载路径。" },
      api_key: {
        title: "MCP 访问密钥",
        desc: "MCP 独立访问令牌，留空则回退 app.api_key。",
      },
    },
  };
  ...
  const SECTION_DESCRIPTIONS = {
    proxy:
      "配置不正确将导致 403 错误。服务首次请求 Grok 时的 IP 必须与获取 CF Clearance 时的 IP 一致，后续服务器请求 IP 变化不会导致 403。",
  };

  const SECTION_ORDER = new Map(
    Object.keys(LOCALE_MAP).map((key, index) => [key, index]),
  );
  ...
  const SECTION_GROUPS = {
    ...
    proxy: [
      ...
      {
        title: "动态代理池",
        keys: ["pool_url", "pool_refresh_sec", "pool_403_max"],
      },
    ],
    chat: [
    ...
    asset: [
      ...
      {
        title: "资产查询",
        keys: ["list_concurrent", "list_timeout", "list_batch_size"],
      },
      {
        title: "资产删除",
        keys: ["delete_concurrent", "delete_timeout", "delete_batch_size"],
      },
    ],
    nsfw: [
    ...
    cache: [{ title: "缓存阈值", keys: ["enable_auto_clean", "limit_mb"] }],
    retry: [
      {
        title: "重试控制",
        keys: ["max_retry", "retry_status_codes", "reset_session_status_codes"],
      },
      {
        title: "退避参数",
        keys: [
    ...
    conversation: [
      {
        title: "会话生命周期",
        keys: ["ttl_seconds", "max_per_token", "cleanup_interval_sec"],
      },
    ...
    stats: [
      {
        title: "统计留存",
        keys: ["hourly_keep", "daily_keep", "save_delay_ms"],
      },
    ],
    logs: [{ title: "日志留存", keys: ["max_len", "save_delay_ms"] }],
    api_keys: [{ title: "API Key 落盘", keys: ["save_delay_ms"] }],
    mcp: [{ title: "MCP 服务", keys: ["enabled", "mount_path", "api_key"] }],
  };
  ...
  function applyInputsToConfig(targetConfig) {
    const inputs = document.querySelectorAll(
      "input[data-section], textarea[data-section], select[data-section]",
    );
  ...
  function renderTabs(allSections) {
    ...
    CONFIG_TABS.forEach((tab) => {
      ...
      if (!hasSection && tab.id === "global") {
        hasSection = allSections.some(
          (section) => !TAB_COVERED_SECTIONS.has(section),
        );
      }
  ...
  function getSectionLabel(section) {
    return (
      (LOCALE_MAP[section] && LOCALE_MAP[section].label) || `${section} 设置`
    );
  }
  ...
  function buildSectionGroups(section, allKeys) {
    ...
    defs.forEach((def) => {
      ...
      groups.push({
        title: def.title || getSectionLabel(section),
        keys,
        desc: def.desc || "",
      });
    });
    ...
    if (rest.length) {
      ...
      for (let i = 0; i < rest.length; i += chunkSize) {
        ...
        const suffix =
          rest.length > chunkSize ? ` ${Math.floor(i / chunkSize) + 1}` : "";
  ...
  function buildBooleanInput(section, key, val) {
    ...
    slider.className =
      "w-9 h-5 bg-[var(--accents-2)] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-black";
  ...
  function buildSecretInput(section, key, val) {
    ...
    genBtn.className =
      "config-icon-btn flex-none w-[32px] h-[32px] flex items-center justify-center rounded-md transition-colors";
    genBtn.type = "button";
    genBtn.title = "生成";
  ...
  function renderConfig(data) {
    ...
    if (!sections.length) {
      ...
      emptyMsg.className = "text-center py-12 text-[var(--accents-4)]";
      emptyMsg.textContent = "暂无配置项";
    ...
    sections.forEach((section) => {
      ...
      const keyOrder = localeSection
        ? new Map(Object.keys(localeSection).map((k, i) => [k, i]))
        : null;
      ...
      sectionWrapper.className = "config-section";

      // Section header
      const blockHeader = document.createElement("div");
      blockHeader.className = "config-section-header";
      ...
      allKeys.forEach((key) => {
        grid.appendChild(buildFieldCard(section, key, items[key]));
      });
  ...
  function buildFieldCard(section, key, val) {
    ...
    if (section === "app" && key === "public_enabled") {
      ...
      link.href = "/login";
      link.className =
        "config-field-action config-icon-btn flex-none w-[32px] h-[32px] flex items-center justify-center rounded-md transition-colors";
      link.title = "功能玩法";
