...
function setupBatchActionsDrag(batchActions) {
  if (!batchActions || batchActions.dataset.dragBound === '1') return;
  batchActions.dataset.dragBound = '1';
...
window.__setupBatchActionsDrag = setupBatchActionsDrag;

const batchActions = document.getElementById('batch-actions');
if (batchActions) {
  setupBatchActionsDrag(batchActions);
}
