...
>
> 感谢原作者 [@chenyme](https://github.com/chenyme) 的开源贡献！
...
# MySQL 存储
docker compose -f docker-compose.full.yml --env-file .env up -d grok2api mysql

# PostgreSQL 存储
docker compose -f docker-compose.full.yml --env-file .env up -d grok2api postgres
```
...
本项目 fork 自 [@chenyme/grok2api](https://github.com/chenyme/grok2api)，感谢原作者的开源贡献！

**原作者**: [@chenyme](https://github.com/chenyme)
**维护者**: [@CPU-JIA](https://github.com/CPU-JIA)
